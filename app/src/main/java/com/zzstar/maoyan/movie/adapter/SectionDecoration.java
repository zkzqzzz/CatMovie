...
public class SectionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionDecoration(Context context, DecorationCallback decorationCallback) {
        ...
        paint = new Paint();
        paint.setColor(res.getColor(R.color.grey_me));
        ...
        topGap = DisplayUtil.dip2px(context, 23);
    }
...
//    }
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            c.drawText(textLine, left + DisplayUtil.dip2px(context, 6), textY - DisplayUtil.dip2px(context, 6), textPaint);
        }
